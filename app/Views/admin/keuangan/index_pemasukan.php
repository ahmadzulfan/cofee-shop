...
<div class="page-content">
    <section class="row">
        <div class="col-12">
            <!-- Filter Tanggal -->
            <form action="<?= base_url('admin/keuangan/dana_masuk') ?>" method="GET" class="mb-4">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 col-lg-3">
                        ...
                        <a href="<?= base_url('admin/keuangan/dana_masuk') ?>" class="btn btn-secondary">Reset Filter</a>
                    </div>
                </div>
            </form>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm border-0">
                        <div class="card-body d-flex align-items-center justify-content-between">
                            <div>
                                <h6 class="text-muted">Dana Masuk</h6>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url('admin/keuangan/ekspor/pemasukan') ?>?start_date=<?= esc($start_date ?? '') ?>&end_date=<?= esc($end_date ?? '') ?>" class="btn btn-danger btn-sm" target="_blank">

<style>
  ...
  #main-header {
    ...
    /* Bayangan halus pengganti border */
  ...
  /* Mengatur tampilan mobile-first */
  .navbar-toggler {
    border: none;
  }
  ...
  <div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg">
      <a class="navbar-brand main-logo" href="<?= base_url() ?>">
        <img src="<?= base_url('static/images/logo/favicon.jpg') ?>" alt="logo" class="img-fluid">
      </a>
      ...
      <div class="collapse navbar-collapse" id="main-nav">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('kontak-kami') ?>">Kontak</a>
          </li>
        </ul>
        ...
        <div class="d-flex align-items-center gap-4 mt-3 mt-lg-0">
          <div class="header-search position-relative d-none d-lg-block">
            <div id="search-form" class="text-center">
              <input id="search-input" type="text" class="form-control" placeholder="Cari kopi favoritmu..." />
            </div>
          ...
          <div class="header-actions">
            <a href="#" class="nav-link d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSearch" aria-controls="offcanvasSearch">
              <svg>
            ...
            <?php else : ?>
              <a href="<?= base_url('auth/login') ?>" class="btn-login">Masuk</a>
            <?php endif; ?>
          </div>
        </div>
      </div>

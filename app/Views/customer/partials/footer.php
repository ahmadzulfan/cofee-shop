    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="footer-menu">
          <h5 class="widget-title">Asar Tamkin</h5>
          <div class="social-links mt-5">
            <ul class="d-flex list-unstyled gap-2">
              <li>
                <a href="https://www.instagram.com/asar_tamkin/" target="_blank" class="btn btn-outline-light">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6 copyright">
        <p>© 2025Asar Tamkin. All rights reserved.</p>
      </div>
    </div>
  </div>
</div>